import 'package:Elservices/features/home/presentation/view/widget/custom_text_field.dart';
import 'package:Elservices/features/home/presentation/view/widget/send_massages.dart';
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ChatCubit, ChatState>(
      builder: (context, state) {
        final messagesToShow = state.selectedMessages.isNotEmpty
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final messageType = message['type'] == 'user'
                      ? MessageType.user
                      : MessageType.bot;
                  switch (messageType) {
